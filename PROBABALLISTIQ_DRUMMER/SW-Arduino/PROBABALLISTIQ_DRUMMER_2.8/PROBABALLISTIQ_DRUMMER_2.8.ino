...
#define useTeensy4 true // use teensy 4 (true) or T3.2 (false)

// MIDI note nums for MIDI out triggers. Change them if u prefer them differently ordered, e.g. 60..63
...
// reverb only for T4, not for T3.2, because of RAM limitations. test
#if useTeensy4
...
const byte rows = 4; // 4 'tracks'/voices; rows in the seq matrix
